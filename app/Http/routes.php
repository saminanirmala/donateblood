...
Route::any('/menuaction', 'dashboard\DashboardController@addMenu');
Route::get('/statusaction', 'dashboard\DashboardController@changeStatus');
Route::any('/searchaction', 'dashboard\DashboardController@search');
